...
public class TablaChequesLog extends AbstractTableModel {
	...
	public TablaChequesLog(List<Cheque> lista){
	...
	public Object getValueAt(int fila, int col) {
		...
		if(col == 4)
			return this.listaCheques.get(fila-1).getEstado();
		return "";
	}
